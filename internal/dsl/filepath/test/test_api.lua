...
print(assert(filepath.work_dir()))
print(assert(filepath.script_dir()))

local exists = filepath.exists("test/unknown")
if exists then error("must be not exists") end

exists = filepath.exists("test/test_api.lua")
if not exists then error("must be exists") end
print("done: filepath.exists()")
